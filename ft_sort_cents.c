...
/*   Updated: 2024/03/01 18:30:52 by yalounic         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_sort_lbig(t_stack *stack)
{
	...
	{
		if (stack->pile_b->valeur < ft_int_lasta(stack) && stack->pile_b->next != NULL)
		{
			ft_rra(stack, 0);
		}
		else
	...
	if (ft_int_lasta(stack) > stack->pile_a->valeur && ft_int_lasta(stack) < stack->pile_a->next->valeur)
	{
		ft_rra(stack, 0);
		ft_sa(stack, 0);
	}
